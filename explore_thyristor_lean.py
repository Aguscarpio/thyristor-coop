...
if __name__ == "__main__":
    ...
    #plot_3d, = ax3d.plot(It_OT[-5000:], Vt_OT[-5000:], Vs_OT[-5000:], color='red', linewidth=0.1)
    ...
    sIin = Slider(IinAx, 'Iin', 0, 3, valinit=1.544)
    RsAx = fig2.add_axes([0.15, 0.75, 0.75, 0.03])
    sRs = Slider(RsAx, 'Rs', 0, 8, valinit=1.85)
    ...
    I0Ax = fig2.add_axes([0.15, 0.11, 0.75, 0.03])
    sI0 = Slider(I0Ax, 'I0', 0, 5 , valinit=0.1)
    Vt0Ax = fig2.add_axes([0.15, 0.08, 0.75, 0.03])
    sVt0 = Slider(Vt0Ax, 'Vt0', 0, 5 , valinit=0.1)
    Vs0Ax = fig2.add_axes([0.15, 0.04, 0.75, 0.03])
    sVs0 = Slider(Vs0Ax, 'Vs0', 0, 5 , valinit=0.1)
    ...
    sVt0.on_changed(update)
    sVs0.on_changed(update)
